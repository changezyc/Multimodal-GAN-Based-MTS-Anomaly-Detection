...
class Discriminator(nn.Module):
    ...
    def __init__(self):
        ...
        self.conv4 = nn.Conv2d(in_channels=128, out_channels=256, kernel_size=(3, 3), stride=2, padding=0)
        self.dense1 = nn.Linear(in_features=4096, out_features=100)
...
class Generator_C(nn.Module):
    def __init__(self):
        ...
        self.dense_c_2 = nn.Linear(in_features=100, out_features=4096)
        self.conv1 = nn.ConvTranspose2d(in_channels=256, out_channels=128, kernel_size=(3, 3), stride=2, padding=0)
        self.conv2 = nn.ConvTranspose2d(in_channels=128, out_channels=64, kernel_size=(3, 3), stride=2, padding=0)
        self.conv3 = nn.ConvTranspose2d(in_channels=64, out_channels=16, kernel_size=(2, 2), stride=2, padding=0)
...
class Generator_R(nn.Module):
    def __init__(self):
        ...
        self.dense_r_3 = nn.Linear(in_features=128, out_features=77)
...
class Encoder_C(nn.Module):
    ...
    def __init__(self):
        ...
        self.conv3 = nn.Conv2d(in_channels=64, out_channels=128, kernel_size=(3, 3), stride=2, padding=0)
        self.conv4 = nn.Conv2d(in_channels=128, out_channels=256, kernel_size=(3, 3), stride=2, padding=0)
        self.dense1 = nn.Linear(in_features=4096, out_features=400)
        self.dense2 = nn.Linear(in_features=400, out_features=40, bias=False)
